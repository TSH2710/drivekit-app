...
/**
 * Hooks for NewsletterSubscriber routes
 */
export interface NewsletterSubscriberHooks {
  /**
...
/**
 * Default NewsletterSubscriber hooks (customize as needed)
 */
export const newsletterSubscriberHooks: NewsletterSubscriberHooks = {
