...
/**
 * Auto-generated NewsletterSubscriber Routes
 *
...
import type { NewsletterSubscriberHooks } from "./newsletter-subscriber.hooks"
...
let hooks: NewsletterSubscriberHooks = {}
...
/**
 * Set hooks for NewsletterSubscriber routes
 */
export function setNewsletterSubscriberHooks(h: NewsletterSubscriberHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["email", "userId", "name", "source", "subscribedAt", "unsubscribed", "unsubscribedAt"] as const
...
/**
 * Create NewsletterSubscriber CRUD routes
 */
export function createNewsletterSubscriberRoutes(): Hono {
  ...
  router.get("/", async (c) => {
    try {
      ...
      console.error("[NewsletterSubscriber] List error:", error)
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "NewsletterSubscriber not found" } }, 404)
      }

      return sendJson(c, { ok: true, data: item })
    } catch (error: any) {
      console.error("[NewsletterSubscriber] Get error:", error)
  ...
  router.post("/", async (c) => {
    try {
      ...
      console.error("[NewsletterSubscriber] Create error:", error)
  ...
  router.patch("/:id", async (c) => {
    try {
      ...
      console.error("[NewsletterSubscriber] Update error:", error)
  ...
  router.delete("/:id", async (c) => {
    try {
      ...
      console.error("[NewsletterSubscriber] Delete error:", error)
