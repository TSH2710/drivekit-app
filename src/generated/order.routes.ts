...
const WRITABLE_SCALAR_FIELDS = ["orderNumber", "userId", "email", "status", "total", "currency", "shippingName", "shippingAddress1", "shippingAddress2", "shippingCity", "shippingState", "shippingZip", "shippingCountry", "shopifyOrderId", "shopifyOrderNum", "promoCode", "discount", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["items", "user"] as const
