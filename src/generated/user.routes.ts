...
const WRITABLE_SCALAR_FIELDS = ["email", "name", "passwordHash", "role", "emailOptIn", "emailVerified", "verificationToken", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["orders", "reviews", "newsletter"] as const
