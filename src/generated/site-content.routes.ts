...
/**
 * Auto-generated SiteContent Routes
 *
...
import type { SiteContentHooks } from "./site-content.hooks"
...
/**
 * Set hooks for SiteContent routes
 */
export function setSiteContentHooks(h: SiteContentHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["key", "value", "updatedAt"] as const
...
/**
 * Create SiteContent CRUD routes
 */
export function createSiteContentRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "SiteContent not found" } }, 404)
      }
  ...
  router.post("/", async (c) => {
    try {
      ...
      console.error("[SiteContent] Create error:", error)
