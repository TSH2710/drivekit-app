...
/**
 * Hooks for ProductOverride routes
 */
export interface ProductOverrideHooks {
  /**
...
/**
 * Default ProductOverride hooks (customize as needed)
 */
export const productOverrideHooks: ProductOverrideHooks = {
