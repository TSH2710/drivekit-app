...
/**
 * Hooks for SiteContent routes
 */
export interface SiteContentHooks {
  /**
...
/**
 * Default SiteContent hooks (customize as needed)
 */
export const siteContentHooks: SiteContentHooks = {
