...
/**
 * Hooks for WaitlistEntry routes
 */
export interface WaitlistEntryHooks {
  /**
...
/**
 * Default WaitlistEntry hooks (customize as needed)
 */
export const waitlistEntryHooks: WaitlistEntryHooks = {
